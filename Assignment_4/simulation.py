...
# with open("CPU_times.txt", "rb") as c:
...
plt.title("Wumpus vs. Firetruck, Run 5, 360 Iterations")
plt.legend()
...
# CPU Time Plots
# plt.bar(1, total_wumpus_CPU_time, 2, color = "black", label = "Wumpus")
# plt.bar(3, total_firetruck_CPU_time,2, color = "red", label = "Firetruck")
# plt.title("CPU Time (s): Wumpus vs. Firetruck, Run 3, 360 Iterations")
# plt.legend()
...
if __name__ == "__main__":
    ...
    for x, y, intact, burned, extinguished, burning, t in zip(wumpus.finalpath_x, wumpus.finalpath_y, intact_sim, burned_sim, extinguished_sim, burning_sim,  t):
        x.sort(), y.sort()
        print(t)
        # plt.cla()
